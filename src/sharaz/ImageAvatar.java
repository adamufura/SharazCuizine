...
public class ImageAvatar extends JComponent{
	 ...
	 * 
	 */
	private static final long serialVersionUID = -8124824181214991778L;
	Icon image;
	int borderSize = 3;
	...
	private Rectangle getAutoSize(Icon thisImage) {
		int w = 66;
		int h = 66;
		int iw = thisImage.getIconWidth();
		int ih = thisImage.getIconHeight();
